package Erebus::App::CGI::ModStarter;
use base 'Erebus::App::CGI';
use Module::Starter; 
...
my $profile = {
	optional => [qw( module_distro )],
	required => [qw( module_author module_license module_names module_email module_builder )],
	constraint_methods => { module_email => email(), }
};
